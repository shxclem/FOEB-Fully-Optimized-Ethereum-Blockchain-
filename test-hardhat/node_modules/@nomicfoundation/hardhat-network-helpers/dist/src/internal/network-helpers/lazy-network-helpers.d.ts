import type { BlockTag, Fixture, NetworkHelpers as NetworkHelpersI, NumberLike, SnapshotRestorer, Time as TimeI } from "../../types.js";
import type { ChainType, NetworkConnection } from "hardhat/types/network";
export declare class LazyNetworkHelpers<ChainTypeT extends ChainType | string> implements NetworkHelpersI<ChainTypeT> {
    #private;
    readonly time: TimeI;
...
//# sourceMappingURL=lazy-network-helpers.d.ts.map