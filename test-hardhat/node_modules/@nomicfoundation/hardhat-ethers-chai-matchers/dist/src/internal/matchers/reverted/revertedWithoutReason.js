    ...
    Assertion.addMethod(REVERTED_WITHOUT_REASON_MATCHER, function () {
        ...
        const onSuccess = async (value) => {
            ...
            if (revertData.kind === "Revert") {
                ...
                throwRevertDataNotRetrievedError("Expected transaction to be reverted without a reason, but the revert data couldn't be retrieved", revertData.retrievalError);
            }
