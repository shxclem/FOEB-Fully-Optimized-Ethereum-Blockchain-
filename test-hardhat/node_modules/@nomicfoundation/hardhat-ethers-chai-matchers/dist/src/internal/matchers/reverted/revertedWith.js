...
export function supportRevertedWith(Assertion, chaiUtils) {
    Assertion.addMethod(REVERTED_WITH_MATCHER, function (expectedReason) {
        ...
        if (!(expectedReason instanceof RegExp) &&
            ...
            chaiAssert.fail("Expected the revert reason to be a string or a regular expression");
        }
        ...
        const onSuccess = async (value) => {
            ...
            if (revertData.kind === "Revert") {
                ...
                throwRevertDataNotRetrievedError(`Expected transaction to be reverted with reason '${expectedReasonString}', but the revert data couldn't be retrieved`, revertData.retrievalError);
            }
