import { type GetType as AbiGetType } from '../advanced/abi-mapper.ts';
...
export declare const eip191Signer: TRet<TypedSigner<string | Uint8Array>>;
...
export declare function encodeType(types: EIP712Types, type: string): string;
export declare function encoder<T extends EIP712Types>(types: T, domain: TArg<GetType<T, 'EIP712Domain'>>): {
    ...
    sign: <K extends Key<T>>(primaryType: K, message: TArg<GetType<T, K>>, privateKey: TArg<Hex>, extraEntropy?: TArg<boolean | Uint8Array>) => string;
    verify: <K extends Key<T>>(primaryType: K, signature: string, message: TArg<GetType<T, K>>, address: string) => boolean;
    recoverPublicKey: <K extends Key<T>>(primaryType: K, signature: string, message: TArg<GetType<T, K>>) => string;
};
...
export declare function getDomainType(domain: TArg<EIP712Domain>): ({
    readonly name: "name";
    readonly type: "string";
} | {
    readonly name: "version";
...
export declare function encodeData<T extends EIP712Types, K extends Key<T>>(typed: TArg<TypedData<T, K>>): string;
export declare function sigHash<T extends EIP712Types, K extends Key<T>>(typed: TArg<TypedData<T, K>>): string;
export declare function signTyped<T extends EIP712Types, K extends Key<T>>(typed: TArg<TypedData<T, K>>, privateKey: TArg<Hex>, extraEntropy?: TArg<boolean | Uint8Array>): string;
export declare function verifyTyped<T extends EIP712Types, K extends Key<T>>(signature: string, typed: TArg<TypedData<T, K>>, address: string): boolean;
export declare function recoverPublicKeyTyped<T extends EIP712Types, K extends Key<T>>(signature: string, typed: TArg<TypedData<T, K>>): string;
