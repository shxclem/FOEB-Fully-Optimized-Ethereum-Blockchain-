...
import { add0x, astring, deepFreeze, ethHex, strip0x } from "../utils.js";
export const addr = /* @__PURE__ */ deepFreeze({
    ...
    RE: Object.freeze(/^(0[xX])?([0-9a-fA-F]{40})?$/),
