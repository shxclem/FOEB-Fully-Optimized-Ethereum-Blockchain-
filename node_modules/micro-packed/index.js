...
const validateFieldName = (name, label) => {
...
const findBytes = (needle, data, pos = 0) => createFindBytes(needle)(data, pos);
    ...
    setRange: (bs, bsLen, pos, len, allowRewrite = true) => {
        ...
        if (!allowRewrite) {
            ...
            if (first !== undefined && first === last) {
                ...
                if (first !== undefined && !canSet(first, FULL_MASK >>> pos % BITS))
                    return false;
...
const Path = /* @__PURE__ */ Object.freeze({
    /**
    ...
    err: (name, stack, msg) => {
        ...
        const err = msg instanceof TypeError
            ? new TypeError(text)
...
class _Reader {
    ...
    finish() {
        ...
        if (this.opts.allowUnreadBytes)
            return;
        if (this.bitPos) {
            throw this.err(`${this.bitPos} bits left after unpack: ${baseHex.encode(this.data.subarray(this.pos))}`);
        }
        ...
        if (!this.isEnd()) {
            throw this.err(`${this.leftBytes} bytes ${this.bitPos} bits left after unpack: ${baseHex.encode(this.data.subarray(this.pos))}`);
        }
    }
    // User methods
    err(msg) {
 ...
 */
const numberBigint = /* @__PURE__ */ Object.freeze({
    encode: (from) => {
 ...
 * ```
 */
export const coders = /* @__PURE__ */ Object.freeze({ dict, numberBigint, tsEnum, decimal, match, reverse });
/**
...
export const U32LE = /* @__PURE__ */ Object.freeze(
...
export const U32BE = /* @__PURE__ */ Object.freeze(
/* @__PURE__ */ intView(4, false, {
...
export const I32LE = /* @__PURE__ */ Object.freeze(
...
export const I32BE = /* @__PURE__ */ Object.freeze(
/* @__PURE__ */ intView(4, true, {
...
export const U16LE = /* @__PURE__ */ Object.freeze(
...
export const U16BE = /* @__PURE__ */ Object.freeze(
/* @__PURE__ */ intView(2, false, {
...
export const I16LE = /* @__PURE__ */ Object.freeze(
...
export const I8 = /* @__PURE__ */ Object.freeze(
...
export const F32BE = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ f32(false));
/** 32-bit little-endian floating point  CoderType ("binary32", IEEE 754-2008). */
export const F32LE = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ f32(true));
/** 64-bit big-endian floating point type ("binary64", IEEE 754-2008). */
export const F64BE = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ f64(false));
/** 64-bit little-endian floating point type ("binary64", IEEE 754-2008). */
export const F64LE = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ f64(true));
/** Boolean CoderType. */
export const bool = /* @__PURE__ */ Object.freeze(
/* @__PURE__ */ wrap({
    size: 1,
    ...
    validate: (value) => {
        if (typeof value !== 'boolean')
            throw new TypeError(`bool: invalid value ${value}`);
        return value;
    },
}));
/**
...
const createBytes = (len, le = false) => {
    ...
    const terminator = _isb ? Uint8Array.from(len) : undefined;
    ...
    return wrap({
        ...
        validate: (value) => {
            ...
            if (findTerminator) {
                ...
                if (findTerminator(data) !== undefined)
...
export const cstring = /* @__PURE__ */ Object.freeze(
...
export function lazy(fn) {
    if (typeof fn !== 'function')
        throw new TypeError(`lazy: expected function, got ${typeof fn}`);
    return wrap({
...
export function optional(flag, inner, def) {
    ...
    const hasDef = def !== undefined;
    return wrap({
        size: hasDef && flag.size !== undefined && inner.size !== undefined
...
export function constant(c) {
    return wrap({
        ...
        encodeStream: (_w, value) => {
            if (value !== c)
                throw new TypeError(`constant: invalid value ${value} (exp: ${c})`);
        },
        decodeStream: (_r) => c,
    });
}
...
export function map(inner, variants) {
    if (!isCoder(inner))
        throw new TypeError(`map: invalid inner value ${inner}`);
    if (!isPlainObject(variants))
        throw new TypeError(`map: variants should be plain object`);
...
export function tag(tag, variants) {
    if (!isCoder(tag))
        throw new TypeError(`tag: invalid tag value ${tag}`);
    if (!isPlainObject(variants))
        throw new TypeError(`tag: variants should be plain object`);
    const variantCoders = new Map();
    for (const name in variants) {
        if (!isCoder(variants[name]))
            throw new TypeError(`tag: variant ${name} is not CoderType`);
        variantCoders.set(name, variants[name]);
        ...
        if (isNum(num) && String(num) === name)
            variantCoders.set(num, variants[name]);
    }
    let size;
    let dataSize;
    ...
    for (const name in variants) {
        ...
        if (cur === undefined || (dataSize !== undefined && cur !== dataSize))
            dynamic = true;
        dataSize = cur;
    }
    if (!dynamic && dataSize !== undefined)
        size = tag.size + dataSize;
    return wrap({
        size,
        encodeStream: (w, value) => {
...
export function mappedTag(tagCoder, variants) {
    if (!isCoder(tagCoder))
        throw new TypeError(`mappedTag: invalid tag value ${tagCoder}`);
    if (!isPlainObject(variants))
        throw new TypeError(`mappedTag: variants should be plain object`);
    const mapValue = new Map();
    const tagValue = new Map();
    ...
    const mapped = Object.fromEntries(mapValue);
    const tagged = Object.fromEntries(tagValue);
    return tag(map(tagCoder, mapped), tagged);
}
/**
 ...
 * ```
 */
export function bitset(names, pad = false, strict = false) {
    ...
    if (!Array.isArray(names))
        throw new TypeError('bitset/names: expected array');
    const nameSet = new Set();
    for (const name of names) {
        if (typeof name !== 'string')
            throw new TypeError('bitset/names: expected array of strings');
        if (strict && nameSet.has(name))
            throw new Error(`bitset/names: duplicate name ${name}`);
    ...
    return wrap({
        ...
        decodeStream: (r) => {
            ...
            if (pad && names.length % 8) {
                ...
                if (strict && padding)
                    throw r.err('bitset: non-zero padding bits');
            }
            return out;
        },
        validate: (value) => {
...
function padLength(blockSize, len) {
    ...
    if (!isNum(len) || len < 0)
        throw new Error(`padLength: wrong length=${len}`);
    if (len % blockSize === 0)
        return 0;
...
export function padLeft(blockSize, inner, padFn) {
    ...
    if (!isCoder(inner))
        throw new TypeError(`padLeft: invalid inner value ${inner}`);
...
export function padRight(blockSize, inner, padFn) {
    if (!isCoder(inner))
        throw new TypeError(`padRight: invalid inner value ${inner}`);
    if (!isNum(blockSize) || blockSize <= 0)
...
export function pointer(ptr, inner, sized = false) {
    if (!isCoder(ptr))
        throw new TypeError(`pointer: invalid ptr value ${ptr}`);
    if (!isCoder(inner))
        throw new TypeError(`pointer: invalid inner value ${inner}`);
    if (typeof sized !== 'boolean')
